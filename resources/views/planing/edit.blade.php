    ...
    <section class="section">
        ...
        <div class="section-body justify-center">
            <div class="col-12 col-md-7 col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('planning.update' , $planning->id)}}" method="post" autocomplete="off">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('user_id') is-invalid @enderror"
                                                    type="text" name="user_id" value="{{old('user_id', $planning->user_id)}}">
                                                @error('user_id')
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('title') is-invalid @enderror"
                                                    type="text" name="title" value="{{old('title', $planning->title)}}">
                                                @error('title')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group mb-3">
                                               ...
                                               <textarea name="description" class="form-control @error('description') is-invalid @enderror" >{{$planning->description}}</textarea>
                                                @error('description')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('start_date') is-invalid @enderror"
                                                    type="date" name="start_date" value="{{old('start_date', $planning->start_date)}}">
                                                @error('start_date')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                type="date" name="end_date" value="{{old('end_date', $planning->end_date)}}">
                                                @error('end_date')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('created_by') is-invalid @enderror"
                                                    type="text" name="created_by" value="{{old('created_by', $planning->created_by)}}">
                                                @error('created_by')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group mb-3">
                                                ...
                                                <input class="form-control @error('updated_by') is-invalid @enderror"
                                                    type="text" name="updated_by" value="{{old('updated_by', $planning->updated_by)}}">
                                                @error('updated_by')
                                                <div class="invalid-feedback">
                                                    {{$message}}
                                                </div>
